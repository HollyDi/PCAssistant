...
NTSTATUS DispatchControlForProcess(PIO_STACK_LOCATION  IrpSp, PVOID OutputBuffer, ULONG_PTR* ulRet)
{
	...
	case IOCTL_PROC_PROCESSLIST:			//进程
	{
	...
	case IOCTL_PROC_KILLPROCESSBYFORCE:	//暴力杀死进程
	{
	...
	case IOCTL_PROC_PROCESSTHREAD:		//线程
	{
	...
	case IOCTL_PROC_PROCESSTHREADMODULE://线程
	{
	...
	case IOCTL_PROC_PROCESSPRIVILEGE:	//权限
	{
	...
	case IOCTL_PROC_PROCESSHANDLE:		//进程句柄
	{
	...
	case IOCTL_PROC_PROCESSWINDOW:		//窗口
	{
	...
	case IOCTL_PROC_PROCESSMODULE:		//进程模块
	{
	...
	case IOCTL_PROC_PROCESSMEMORY:		//进程内存
	{
...
NEXT:
			if (IsRealProcess(EProcess))	//判断是否僵尸进程
			{
